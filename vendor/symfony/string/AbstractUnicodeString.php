 ...
 */
namespace Lines202307\Symfony\Component\String;

use Lines202307\Symfony\Component\String\Exception\ExceptionInterface;
use Lines202307\Symfony\Component\String\Exception\InvalidArgumentException;
use Lines202307\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    {
        $str = $this->camel();
        $str->string = \mb_strtolower(\preg_replace(['/(\\p{Lu}+)(\\p{Lu}\\p{Ll})/u', '/([\\p{Ll}0-9])(\\p{Lu})/u'], 'Lines202307\\1_\\2', $str->string), 'UTF-8');
        return $str;
    }
    /**
     * @return static
